...
{
  [Serializable]
  public class TransformAdditionalSizeStrategy : ObjectSizeStrategy
  {
    ...
    public override void Apply(Vector2 size)
    {
      ...
      Vector2 targetSize = size + _additionalSize;
      float scaleX = targetSize.x / _originalSize.x;
      float scaleY = targetSize.y / _originalSize.y;
